  ...
  return (
    <section id="courses" className="py-20 bg-white px-4">
      <div className="container mx-auto max-w-5xl">
        {/* Section header */}
        <div className="mb-12">
          <p className="text-xs font-mono uppercase tracking-widest text-emerald-500 mb-2">Backend & Data</p>
          ...
          {coursesBackend.map((course, index) => {
            ...
            const card = (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -4 }}
                className="group relative bg-white rounded-2xl border border-neutral-200 overflow-hidden hover:border-emerald-300 hover:shadow-[0_8px_32px_rgba(16,185,129,0.1)] transition-all duration-300 cursor-pointer"
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {href && (
                      <span className="text-[12px] font-bold text-emerald-500 group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                        Start →
                      </span>
                    )}
                  </div>
