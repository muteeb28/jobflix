                    ...
                    {coursesBackend.map((course, index) => {
                        ...
                        const CardContent = (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                whileHover={{ y: -10 }}
                                className="bg-gray-900 rounded-xl overflow-hidden border-4 border-gray-800 hover:border-yellow-500 transition-colors group shadow-[8px_8px_0_rgba(0,0,0,0.5)] cursor-pointer"
                            >
                                {/* Course Image */}
