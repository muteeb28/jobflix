  ...
  return (
    <section className="py-20 bg-white px-4">
      <div className="container mx-auto max-w-5xl">
        {/* Header */}
        <div className="mb-12">
          <p className="text-xs font-mono uppercase tracking-widest text-brand-500 mb-2">Why us</p>
          <h2
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="w-10 h-10 bg-brand-50 border border-brand-200 rounded-xl flex items-center justify-center mb-4 group-hover:bg-brand-100 transition-colors">
                {feature.icon}
              </div>
