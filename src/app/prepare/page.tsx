...
const topicColors: Record<string, string> = {
  ...
  "Binary Search": "text-neutral-900 bg-neutral-100",
  ...
  "JS Utilities": "text-neutral-900 bg-neutral-100",
        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-neutral-1000 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-neutral-200/50 transition-colors"
                />
              </div>

              {/* Difficulty Filter */}
              <div className="flex items-center gap-1.5 p-1 bg-neutral-1000 border border-neutral-200 rounded-xl">
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {availableTopics.map((topic) => (
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-all ${
                      topicFilter === topic
                        ? topicColors[topic] || "bg-neutral-100 text-neutral-900"
                        : "text-neutral-500 hover:text-neutral-500"
                    }`}
                  >
                    {topic}
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20 gap-3">
              ...
              <p className="text-neutral-500 text-sm">Loading problems...</p>
            </div>
          ) : error ? (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
              ...
              <div className="text-center">
                <p className="text-neutral-900 font-bold mb-1">Connection Error</p>
            ...
            <div className="space-y-2">
              {/* Table Header */}
              <div className="grid grid-cols-[1fr_80px_80px_40px] md:grid-cols-[1fr_100px_100px_80px_40px] items-center px-4 py-2 text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-400">
                <span>Title</span>
              ...
              {filtered.map((problem, idx) => {
                ...
                const tc = topicColors[topic] || "text-neutral-500 bg-zinc-400/10";
                return (
                  <Link
                    key={problem.id}
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <span className="text-sm font-semibold text-neutral-900 truncate group-hover:text-neutral-600 transition-colors">
                        {problem.title}
                      </span>
                    </div>
