                    ...
                    <div className="flex justify-center">
                        <div className="flex p-1 bg-white border border-neutral-200 rounded-xl relative">
                            ...
                            <button
                                ...
                                className={`relative z-10 px-6 py-2 rounded-lg text-sm font-bold uppercase tracking-wider transition-colors w-40 md:w-48 text-center ${activeTab === "mentors" ? "text-neutral-900" : "text-neutral-400 hover:text-neutral-600"
                                    }`}
                            >
                                Mentors
                            </button>
